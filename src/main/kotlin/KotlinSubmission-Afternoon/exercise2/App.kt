...
fun main() {
     ...
     */
    // Buat di bawah sini
    // Buat variabel list untuk menampung bilangan genap
    val evenNumbers = mutableListOf<Int>()

    // Gunakan for loop dan logika if untuk mengisi list dengan bilangan genap
    for (i in 1..100) {
        if (i % 2 == 0) {
            evenNumbers.add(i)
        }
    ...
    val monthNow = "November" // Ganti dengan bulan sekarang
    val birthMonth = "July" // Ganti dengan bulan lahir Anda
